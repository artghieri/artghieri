...
When I switch off the computer, you'll find me lost in books, soaking up the genuine joy of learning and the pure fun of stories. And, by the way, I'm a huge fan of both NBA and NFL! 📚🏀🏈

I am also an active contributor to the open-source world, where I enjoy collaborating and sharing knowledge. I firmly believe that when we collaborate, it goes beyond code, creating a positive impact on our world!
...
- **Hosting/Saas:** Amazon Web Services (AWS), Azure, Google Cloud
- **DevOps:** Apache Kafka, Azure DevOps, Prometheus
- **ML/DL:** MatPlotLib, MLFlow, NumPy, Pandas, PyTorch, SCIKIT-LEARN, TensorFlow
- **Database:** Relational Database (SQL, PostgreSQL) / Non-Relational Database (MongoDB, DynamoDB)
- **Other:** Git, GitHub, GitLab, Linux, Jupyter, Anaconda, MarkDown
